...
<?php include("wholesalermenu.php");?>
		...
		<div class="container py-xl-4 py-lg-2">
			<table class="table table-hover">
				...
				?>
					...
					<td>
					<a  href="wholesaler-stock-edit.php?id=<?php print $row[0]?>"  class="btn btn-primary">Edit</a>
						<a  href="wholesaler-stock.php?id=<?php print $row[0]?>" onclick="return confirm('Do you want to delete ?')" class="btn btn-danger">Delete</a>					

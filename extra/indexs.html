			...
			<div class="container py-md-5 py-sm-4 py-3">
				<div class="row footer-info w3-agileits-info">
					...
					<div class="col-md-3 col-sm-6 footer-grids mt-md-0 mt-4">
						...
						<ul>
							<li class="mb-3">
								<i class="fas fa-map-marker"></i> CU Shah Polytechnic,Mulchand Road,Near Shraddha Hotel,Wadhwan GIDC(363035),Gujarat,India.</li>
							<li class="mb-3">
								<i class="fas fa-mobile"></i> +91 9586756176 </li>
							<li class="mb-3">

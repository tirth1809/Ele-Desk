...
<body>
				...
				<div class="col-lg-8 header-right mt-lg-0 mt-2">
					...
					<ul>
						...
						<li class="text-center border-right text-white">
							<i class="fas fa-phone mr-2"></i> +91 9586756176
						</li>
						<li class="text-center border-right text-white">
				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="index.html" class="font-weight-bold font-italic">
							<img src="images/logo2.png" alt=" " class="img-fluid">Ele-Desk
						</a>
					</h1>
				</div>
				<!-- //logo -->
			...
			<div class="row contact-grids agile-1 mb-5">
				<div class="col-sm-4 contact-grid agileinfo-6 mt-sm-0 mt-2">
					<div class="contact-grid1 text-center">
						...
						<p>CU Shah Polytechnic,Mulchand Road,Near Shraddha Hotel,Wadhwan GIDC(363050),Gujarat,
							<label>India.</label>
						</p>
					</div>
				</div>
				...
				<div class="col-sm-4 contact-grid agileinfo-6">
					<div class="contact-grid1 text-center">
						...
						<p>
							<a href="mailto:info@example.com">cushahproject7777@gmail.com</a>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="container py-md-5 py-sm-4 py-3">
				<div class="row footer-info w3-agileits-info">
					...
					<div class="col-md-3 col-sm-6 footer-grids mt-md-0 mt-4">
						...
						<ul>
							<li class="mb-3">
								<i class="fas fa-map-marker"></i> CU Shah Polytechnic,Mulchand Road,Near Shraddha Hotel,Wadhwan GIDC(363050),Gujarat,India.</li>
							<li class="mb-3">
								<i class="fas fa-phone"></i> +91 9586756176 </li>
							<li class="mb-3">
	...
	<div class="copy-right py-3">
		<div class="container">
			<p class="text-center text-white">© 2022 Ele-Desk. All rights reserved | Developed by 
				<a href="http://w3layouts.com"> Jimit Dagli,Vishal Parmar,Sumeet Kapadia,Tirth Doshi.</a>
			</p>
		</div>
	</div>
	<!-- //copyright -->
